...
echo -e "${GREEN}║                                                       ║${NC}"
echo -e "${GREEN}║  1. Setup DNS di Cloudflare (A record):               ║${NC}"
echo -e "${GREEN}║     finance-bot     → 103.179.71.33 (Proxied)        ║${NC}"
echo -e "${GREEN}║     api.finance-bot → 103.179.71.33 (Proxied)        ║${NC}"
echo -e "${GREEN}║                                                       ║${NC}"
echo -e "${GREEN}║  2. Cloudflare SSL/TLS → pilih 'Full'                 ║${NC}"
echo -e "${GREEN}║     (Tidak perlu certbot, Cloudflare handle SSL)      ║${NC}"
echo -e "${GREEN}║                                                       ║${NC}"
